    ...
    return Column(
      children: [
        ...
        GetBuilder<PopularProductController>(builder: (popularProducts){
          // print("object= ${popularProducts.popularProductList.toList()}");
        ...
        GetBuilder<RecommendedProductController>(builder: (recommendedProducts){
          return recommendedProducts.isloaded ? ListView.builder(
              ...
              itemBuilder: (context,index){
                final recommendedProduct = recommendedProducts.recommendedProductList[index];
